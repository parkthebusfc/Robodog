...
from go1_gym_learn.ppo_nav.rollout_storage_nav import RolloutStorage
#from go1_gym_learn.ppo_nav import caches
...
class PPO:
    ...
    def act(self, obs, obs_history):
        ...
        self.transition.values = self.actor_critic.evaluate(obs_history).detach()
    ...
    def update(self):
        ...
        for obs_batch, critic_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
            ...
            value_batch = self.actor_critic.evaluate(obs_history_batch, masks=masks_batch)
