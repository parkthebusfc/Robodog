...
def load_policy(logdir):
    ...
    import os
    adaptation_module = torch.jit.load('../tmp/legged_data/adaptation_module_latest.jit')
...
def dog_walk(env,policy, obs, num_eval_steps = 750):
    # num_eval_steps = 250
    ...
    while not done and i < num_eval_steps:
        ...
        x_vel_cmd, y_vel_cmd, yaw_vel_cmd = actions
        print(actions.shape)
...
def play_go1(headless=True):
    ...
    obs = env.reset()
    obs_vel = dog_walk(env,policy, obs)
